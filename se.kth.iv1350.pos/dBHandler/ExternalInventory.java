...
public class ExternalInventory {
	...
	/**
	 * Checks if the given itemID is valid for any of the items 
	 * in the inventory. if so, the system will fetch that item 
	 * and update the inventory depending on the amount requested
	 * @param ItemID The given item identifier
	 * @param quantity The amount currently requested
	 * @return An ItemDTO with a matching ID
